...
<head>
	...
	<title><?php echo "My Followers - $title $version - $nick"; ?></title>
...
<body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="friends.php"><img src="ico/16px/16_users.png"></a></li>
    ...
    <div class="container">
		<h3>My Followers:</h3>
		<?php
		$lineas=file('./data/followers.txt');
